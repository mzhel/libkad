 ...
 */
 ...
 /*
  ...
  Commented out for kad project because of use of stdlib functions.
  we do not use them in this project.
...
#undef POLARSSL_SELF_TEST /* Added for kad project, do not need self test and stdlib.*/
